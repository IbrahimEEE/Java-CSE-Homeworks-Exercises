...
public class HW3_150719046_P1 {
	...
	public static void draw_line() {
         ...
         * 
         * draw_line method written by Ibrahim Týnas 
         * 
         */
	...
	public static void draw_triangular() {
         ...
         * 
         * draw_triangular method written by Ibrahim Týnas 
         * 
         */
		...
		int max_x = Math.max(Math.max(a, c), e);
	...
	public static void draw_rectangle() {
         ...
         * 
         * draw_rectangle method written by Ibrahim Týnas 
         * 
         */
        ...
        int max_x = Math.max(Math.max(a, c), Math.max(e, g));
	...
	public static void draw_parabola() {
         ...
         * 
         * draw_parabola method written by Ibrahim Týnas 
         * 
         */
	...
	public static void draw_circle() {
         ...
         * 
         * draw_circle method written by Ibrahim Týnas 
         * 
         */
